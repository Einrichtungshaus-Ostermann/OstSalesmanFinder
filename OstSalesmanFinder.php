...
class OstSalesmanFinder extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_salesman_finder.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_salesman_finder.view_dir', $this->getPath() . '/Resources/views/');
